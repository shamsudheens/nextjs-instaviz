...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white text-gray-900">
      ...
      {/* ---------- RIGHT PANEL ---------- */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 py-12 bg-white relative">
        {/* Mobile Header */}
        <h1 className="lg:hidden text-4xl font-bold text-center text-[#AD49E1] mb-10 absolute top-25 left-1/2 -translate-x-1/2">
          InstaviZ
        </h1>

        <div className="max-w-md mx-auto w-full mt-10 sm:mt-0">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-4xl font-bold mb-2">Create your account</h2>
            <p className="text-[#9B5DE0] text-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full h-11 pl-10 border rounded-md border-purple-300 focus:ring-2 focus:ring-indigo-500 outline-none"
                  required
                />
              </div>
            </div>
